...
from pytorch_advanced.c02_ssd.ssd_model import DataTransform, VOCDataset, od_collate_fn
...
def main():
    ...
    # 辞書オブジェクトにまとめる
    dataloaders_dict_menzu = {
        "train": train_dataloader_menzu,
        "val": val_dataloader_menzu,
    }
